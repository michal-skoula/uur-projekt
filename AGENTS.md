...
- `cms-features` — Apply this skill whenever writing, reviewing, or refactoring any CMS module code — page builder sections (schemas, templates, blade views), the registry, or related Filament resources.
